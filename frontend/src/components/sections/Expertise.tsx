      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center mb-16">
            <span className="inline-block px-4 py-2 bg-secondary-900/30 text-secondary-400 rounded-full text-sm font-medium mb-4">
              Core Expertise
            </span>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {validCategories.map((category, categoryIndex) => (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-neutral-800 rounded-2xl p-8 h-full border border-neutral-700 hover:shadow-card-hover transition-all duration-300">
                  {/* Category Header */}
                    ...
                    {category.skills.slice(0, 6).map((skill, skillIndex) => {
                      return (
                        <motion.div
                          ...
                          className="flex items-center justify-between p-3 bg-neutral-700 rounded-lg border border-neutral-600 hover:border-neutral-500 transition-colors duration-200"
                        >
          ...
          >
            <div className="bg-gradient-to-br from-primary-900/20 to-secondary-900/20 rounded-2xl p-8 border border-primary-800">
